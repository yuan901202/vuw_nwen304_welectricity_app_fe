 ...
 *
 * This was originally copied from user loicknuchel from the ionic framework forums.
 * Url: http://forum.ionicframework.com/t/how-to-play-local-audio-files/7479/4
 */
angular.module('welc.services')
    .factory('MediaService', function ($q, $ionicPlatform, $window) {
        ...
        /**
         * Function to fallback to plugin if this application is being run on the browser.
         */
        function emulateBrowser() {
            if($ionicPlatform.is('ios') || $ionicPlatform.is('android') || $ionicPlatform.is('windowsphone')) {
                return;
            } else {
