...
!function () {
    function e(e, t, n, i, o, r) {
        function a(i, a, c, s, l) {
            ...
            var T, B = C[1], I = C[2], x = t(I), A = {}, E = {}, V = {}, P = [], D = c.itemRenderBuffer || c.collectionBufferSize, _ = angular.isDefined(D) ? parseInt(D) : S, L = c.itemHeight || c.collectionItemHeight, R = c.itemWidth || c.collectionItemWidth, N = p(), z = f();
    ...
    function t(e, t, n) {
        ...
        return function (o) {
            ...
            }, L = !!I.options.scrollingY, R = L ? k.dynamic || k.value !== I.__clientWidth : S.dynamic || S.value !== I.__clientHeight, N = !S.dynamic && !k.dynamic, z = "PRIMARY", M = "SECONDARY", H = L ? "translate3d(SECONDARYpx,PRIMARYpx,0)" : "translate3d(PRIMARYpx,SECONDARYpx,0)", O = L ? "height: PRIMARYpx; width: SECONDARYpx;" : "height: SECONDARYpx; width: PRIMARYpx;", U = 0, q = 0, W = -1, F = -1, X = -1, Y = -1, G = [], j = [], K = [], Z = {}, J = 0, Q = L ? function () {
            ...
            this.refreshLayout = function () {
                ...
                if ($.style[ionic.CSS.TRANSFORM] = H.replace(z, -l).replace(M, 0), U -= l, I.__clientHeight && I.__clientWidth || (I.__clientWidth = I.__container.clientWidth, I.__clientHeight = I.__container.clientHeight), (ee.onRefreshLayout || angular.noop)(), ee.refreshDirection(), Q(), !ie)for (var u = Math.max(20, 3 * T), d = 0; u > d; d++)G.push(new s);
    ...
    c.factory("$ionicActionSheet", ["$rootScope", "$compile", "$animate", "$timeout", "$ionicTemplateLoader", "$ionicPlatform", "$ionicBody", "IONIC_BACK_PRIORITY", function (e, t, n, i, o, r, a, c) {
        ...
        var b, y, S, k, C = "initialView", T = "newView", B = "moveBack", I = "moveForward", x = "back", A = "forward", E = "enter", V = "exit", P = "swap", D = "none", _ = 0, L = {
            histories: {
                root: {
                    historyId: "root",
        ...
        return R.prototype.initialize = function (e) {
            ...
            register: function (e, t) {
                var i, a, s, u = g(), d = h(e), $ = L.currentView, R = L.backView, N = L.forwardView, z = null, M = null, H = D, O = d.historyId, U = n.url();
                if (b !== u && (b = u, _++), k)z = k.viewId, M = k.action, H = k.direction, k = null; else if (R && R.stateId === u)z = R.viewId, O = R.historyId, M = B, R.historyId === $.historyId ? H = x : $ && (H = V, i = f(R.historyId), i && i.parentHistoryId === $.historyId ? H = E : (i = f($.historyId), i && i.parentHistoryId === d.parentHistoryId && (H = P))); else if (N && N.stateId === u)z = N.viewId, O = N.historyId, M = I, N.historyId === $.historyId ? H = A : $ && (H = V, $.historyId === d.parentHistoryId ? H = E : (i = f($.historyId), i && i.parentHistoryId === d.parentHistoryId && (H = P))), i = p(e), N.historyId && i.scope && (i.scope.$historyId = N.historyId, O = N.historyId); else if ($ && $.historyId !== O && d.cursor > -1 && d.stack.length > 0 && d.cursor < d.stack.length && d.stack[d.cursor].stateId === u) {
                    ...
                    z = q.viewId, O = q.historyId, M = B, H = P, i = f($.historyId), i && i.parentHistoryId === O ? H = V : (i = f(O), i && i.parentHistoryId === $.historyId && (H = E)), i = c(q.backViewId), i && q.historyId !== i.historyId && (d.stack[d.cursor].backViewId = $.viewId)
                } else {
                    ...
                    2 > _ && (H = D), L.views[z] = this.createView({
                        viewId: z,
                ...
                if (o.cancel(S), y) {
                    if (y.disableAnimate && (H = D), y.disableBack && (L.views[z].backViewId = null), y.historyRoot) {
                ...
                if (v(z), L.backView && O == L.backView.historyId && u == L.backView.stateId && U == L.backView.url)for (a = 0; a < d.stack.length; a++)if (d.stack[a].viewId == z) {
                    M = "dupNav", H = D, a > 0 && (d.stack[a - 1].forwardViewId = null), L.forwardView = null, L.currentView.index = L.backView.index, L.currentView.backViewId = L.backView.backViewId, L.backView = l(L.backView), d.stack.splice(a, 1);
                    break
                }
        ...
        }), e("windowsphone", {scrolling: {jsScrolling: !1}}), o.transitions = {
            views: {},
            navBar: {}
        ...
        e.aHrefSanitizationWhitelist(/^\s*(https?|ftp|mailto|file|ghttps?|ms-appx|x-wmapp0):/), e.imgSrcSanitizationWhitelist(/^\s*(https?|ftp|file|ms-appx|x-wmapp0):|data:image\//)
    }]);
            ...
            create: function (t, l, h, T, E, L) {
                var R, N, z, M = ++A, H = {
                    init: function (e, t) {
                        ...
                        z = !!R, z || (R = e.ele || _.createViewEle(l), R.data(y, c)), L && t.activeEleId(c), e.ele = null
                    }, render: function (e, n) {
                        if (z)ionic.Utils.reconnectScope(R.scope()); else {
                            p(R, x);
                        ...
                        function v() {
                            p(R, W.shouldAnimate ? "entering" : B), p(N, W.shouldAnimate ? "leaving" : I), W.run(1), r._instances.forEach(function (e) {
                        ...
                        function b() {
                            b.x || (b.x = !0, R.off($, w), e.cancel(R.data(k)), N && e.cancel(N.data(k)), H.emit("after", O, U), C && C.resolve(t), M === A && (n.all(P).then(_.transitionEnd), H.cleanup(O)), r._instances.forEach(function (e) {
                        ...
                        O.transitionId = U.transitionId = M, O.fromCache = !!z, O.enableBack = !!c, O.renderStart = E, O.renderEnd = L, V(R.parent(), "nav-view-transition", O.transition), V(R.parent(), "nav-view-direction", O.direction), e.cancel(R.data(k));
                        var q = o.transitions.views[O.transition] || o.transitions.views.none, W = q(R, N, O.direction, O.shouldAnimate && u && L);
                        if (W.shouldAnimate && (R.on($, w), R.data(k, e(b, D)), i.show(D)), E && (H.emit("before", O, U), p(R, x), W.run(0)), L && (C = n.defer(), P.push(C.promise)), E && L)e(v, 16); else {
                            if (!L)return p(R, "entering"), p(N, "leaving"), {
                                run: W.run, cancel: function (t) {
                                    t ? (R.on($, y), R.data(k, e(S, D)), i.show(D)) : S(), W.shouldAnimate = t, W.run(0), W = null
                                }
                            };
                            L && v()
                        }
